...
const servicesList = [
  ...
  },
  {
    ...
    desc: "Khi khách đã có nhu cầu tìm quán, lớp học hoặc dịch vụ quanh khu vực, doanh nghiệp phải xuất hiện đúng thời điểm.",
    detail: "Tối ưu Google Maps/GBP, từ khóa địa phương, nội dung bản đồ và dữ liệu chuyển đổi để biến lượt tìm kiếm thành cuộc gọi, tin nhắn hoặc lượt ghé cửa hàng.",
  ...
  },
  {
    ...
    desc: "Khi trung tâm có chương trình học tốt nhưng lead không đều, cần đồng bộ ads, content và tư vấn tuyển sinh.",
    detail: "Thiết kế phễu tuyển sinh, điều phối content team, tối ưu lead Messenger/form và chuyển giao quy trình cho đội ngũ in-house.",
