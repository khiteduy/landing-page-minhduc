...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full bg-[#F8FAF9]/80 backdrop-blur-md z-50 border-b border-[#0A0F1C]/5 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between uppercase tracking-widest text-xs font-bold">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="px-6 py-3 bg-[#0A0F1C] text-white rounded-full hover:bg-[#2563EB] transition-all duration-300 text-[10px] tracking-widest uppercase font-bold shadow-sm hover:shadow-md"
          >
            Hợp tác ngay
          </a>
          <button
            type="button"
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#0A0F1C]/5 text-[#0A0F1C] bg-white hover:bg-slate-50 transition-colors md:hidden"
      ...
      {mobileMenuOpen && (
        <nav className="px-6 pb-6 md:hidden animate-slide-down bg-[#F8FAF9] border-b border-[#0A0F1C]/5 shadow-sm">
