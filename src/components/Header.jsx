      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between uppercase tracking-widest text-xs font-bold">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="px-6 py-3 bg-[#0B74E8] text-white rounded-full hover:bg-[#0758B8] transition-all duration-300 text-[10px] tracking-widest uppercase font-bold shadow-sm hover:shadow-md"
          >
            Hợp tác ngay
          </a>
          <button
