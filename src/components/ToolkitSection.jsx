  ...
  return (
    <section id="toolkit" className="py-28 bg-[#F8FAF9] border-b border-[#0A0F1C]/5">
      <div className="section-container">
        ...
        <div className="toolkit-hero p-8 sm:p-12 lg:p-16 rounded-3xl bg-[#0F4C81] text-white relative overflow-hidden border border-[#B7D9F4]/30 shadow-[0_25px_80px_rgba(15,76,129,0.16)]">
          <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.12),transparent_38%),radial-gradient(circle_at_top_right,rgba(244,211,94,0.22),transparent_46%)] pointer-events-none" />
          
          {toolkitForm.success ? (
            <div className="relative flex flex-col items-center justify-center py-12 text-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#F4D35E] text-[#0A0F1C] shadow-md animate-pulse">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="mt-6 text-xl font-bold text-white uppercase tracking-wider animate-fade-in">
                Đăng ký nhận bộ siêu Target thành công!
              </h3>
              <p className="mt-3 max-w-md text-slate-300 text-sm leading-relaxed">
                Cảm ơn bạn. Minh Duc Global sẽ gửi bộ siêu Target tổng hợp ngành hàng qua số điện thoại/Zalo bạn đã đăng ký.
              </p>
              <button
                type="button"
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6">
                ...
                <h2 className="mt-3 text-3xl sm:text-4xl font-black leading-tight text-white uppercase tracking-tight font-display">
                  Minh Duc Global gửi tặng bạn <br />Bộ siêu Target ngành hàng.
                </h2>
                <p className="mt-4 text-blue-50/90 text-sm sm:text-base leading-relaxed">
                  Đây là bộ target được Minh Duc Global tổng hợp sau hơn 5 năm kinh nghiệm triển khai quảng cáo thực chiến cho nhiều nhóm ngành. Bạn có thể dùng làm điểm bắt đầu để nghiên cứu khách hàng, test nhóm đối tượng và xây chiến dịch nhanh hơn.
                </p>
              ...
              <div className="lg:col-span-6 bg-white p-6 sm:p-8 rounded-2xl border border-white/30 shadow-[0_20px_60px_rgba(10,15,28,0.12)]">
                <h4 className="text-sm font-bold uppercase tracking-wider text-[#0F4C81] mb-2">
                  Nhận bộ siêu Target miễn phí
                </h4>
                ...
                <form onSubmit={toolkitForm.handleSubmit} className="flex flex-col gap-5">
                      ...
                      <input
                        ...
                        className={`w-full text-slate-900 placeholder:text-slate-400 text-sm outline-none transition-all ${
                          toolkitForm.errors.name 
                            ...
                            : "border-slate-200 bg-slate-50 focus:bg-white focus:border-[#0F4C81]"
                        }`}
                      />
                      {toolkitForm.errors.name && (
                  ...
                  <div className="rounded-xl border border-[#0F4C81]/15 bg-[#EAF4FB] p-4 text-xs leading-relaxed text-[#0F4C81] font-semibold">
                    Tài liệu đăng ký: Bộ siêu Target tổng hợp ngành hàng sau hơn 5 năm kinh nghiệm.
                  </div>
                  ...
                  <button
                    ...
                    className="btn-awwwards w-full text-center mt-2 py-4 bg-[#F4D35E] text-[#0A0F1C] hover:bg-[#ffe27a] font-extrabold"
                  >
                    {toolkitForm.loading ? "Đang xử lý..." : "Nhận bộ siêu Target ngay"}
                  </button>
