    ...
    <div className="min-h-screen bg-[#F8FAF9] text-[#0A0F1C]">
      ...
      <main>
        <section className="pt-36 pb-20 border-b border-[#0A0F1C]/5 bg-white">
          <div className="section-container grid gap-12 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-5">
              <div className="grid gap-4 sm:grid-cols-5">
                <div className="image-reveal-card h-72 border border-blue-100 sm:col-span-3">
                  <img
                    ...
                    loading="eager"
                  />
                  <span className="absolute bottom-5 left-5 z-10 rounded-full bg-white/90 px-4 py-2 text-[10px] font-black uppercase tracking-wider text-[#0758B8]">
                    Social Growth
                  </span>
                </div>
                <div className="grid gap-4 sm:col-span-2">
                  <div className="rounded-3xl border border-blue-100 bg-blue-50 p-5">
                    <p className="text-3xl font-black text-[#0B74E8]">24/7</p>
                    <p className="mt-2 text-[10px] font-bold uppercase tracking-wider text-slate-500">Theo dõi lỗi nền tảng</p>
                  </div>
              ...
              <a href="#contact" className="btn-awwwards btn-awwwards-solid mt-6 w-full">
              ...
              {serviceBlocks.map((item, index) => (
                <article key={item.title} className="bento-card min-h-[260px]">
                  <div className="image-reveal-card mb-7 h-44 border border-blue-100">
                    <img src={item.image} alt={`Minh họa ${item.title}`} loading="lazy" />
